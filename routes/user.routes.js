...
const { findById, getUsers, requestPasswordReset, resetPassword, signIn, signUp, updateUser, findByEmail, upload, attachFile, deleteAccount, findByUserType, createAccountForUser } = require('../controllers/user.controllers');
